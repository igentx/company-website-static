...
const STORY_SLUG = 'blog/technical-seo-checklist-uae'
const CANONICAL_PATH = '/blog/technical-seo-checklist-uae'
...
export default async function BlogtechnicalseochecklistuaePage({ params }: Props) {
