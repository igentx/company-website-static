...
const STORY_SLUG = 'blog/daycaremate-childcare-management-software-guide'
const CANONICAL_PATH = '/blog/daycaremate-childcare-management-software-guide'
...
export default async function BlogDaycareMateGuidePage({ params }: Props) {
