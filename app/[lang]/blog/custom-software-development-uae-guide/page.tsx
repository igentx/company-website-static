...
const STORY_SLUG = 'blog/custom-software-development-uae-guide'
const CANONICAL_PATH = '/blog/custom-software-development-uae-guide'
...
export default async function BlogcustomsoftwaredevelopmentuaeguidePage({ params }: Props) {
