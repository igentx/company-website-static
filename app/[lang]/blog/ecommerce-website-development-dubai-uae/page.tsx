...
const STORY_SLUG = 'blog/ecommerce-website-development-dubai-uae'
const CANONICAL_PATH = '/blog/ecommerce-website-development-dubai-uae'
...
export default async function BlogecommercewebsitedevelopmentdubaiuaePage({ params }: Props) {
