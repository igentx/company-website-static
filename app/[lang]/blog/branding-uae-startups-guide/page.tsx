...
const STORY_SLUG = 'blog/branding-uae-startups-guide'
const CANONICAL_PATH = '/blog/branding-uae-startups-guide'
...
export default async function BlogbrandinguaestartupsguidePage({ params }: Props) {
