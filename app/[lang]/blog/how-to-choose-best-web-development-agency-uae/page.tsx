...
const STORY_SLUG = 'blog/how-to-choose-best-web-development-agency-uae'
const CANONICAL_PATH = '/blog/how-to-choose-best-web-development-agency-uae'
...
export default async function BlogChooseAgencyPage({ params }: Props) {
