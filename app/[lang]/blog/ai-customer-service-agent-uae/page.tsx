...
const STORY_SLUG = 'blog/ai-customer-service-agent-uae'
const CANONICAL_PATH = '/blog/ai-customer-service-agent-uae'
...
export default async function BlogAiAgentUaePage({ params }: Props) {
