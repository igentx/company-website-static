...
const STORY_SLUG = 'blog/ai-in-web-development-uae'
const CANONICAL_PATH = '/blog/ai-in-web-development-uae'
...
export default async function BlogAiWebDevPage({ params }: Props) {
