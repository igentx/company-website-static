...
const STORY_SLUG = 'blog/importance-of-website-uae'
const CANONICAL_PATH = '/blog/importance-of-website-uae'
...
export default async function BlogImportancePage({ params }: Props) {
