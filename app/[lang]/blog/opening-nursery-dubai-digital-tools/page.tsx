...
const STORY_SLUG = 'blog/opening-nursery-dubai-digital-tools'
const CANONICAL_PATH = '/blog/opening-nursery-dubai-digital-tools'
...
export default async function BlogopeningnurserydubaidigitaltoolsPage({ params }: Props) {
