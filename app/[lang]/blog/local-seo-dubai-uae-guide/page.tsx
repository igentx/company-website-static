...
const STORY_SLUG = 'blog/local-seo-dubai-uae-guide'
const CANONICAL_PATH = '/blog/local-seo-dubai-uae-guide'
...
export default async function BloglocalseodubaiuaeguidePage({ params }: Props) {
