...
const STORY_SLUG = 'blog/bilingual-website-development-uae'
const CANONICAL_PATH = '/blog/bilingual-website-development-uae'
...
export default async function BlogbilingualwebsitedevelopmentuaePage({ params }: Props) {
