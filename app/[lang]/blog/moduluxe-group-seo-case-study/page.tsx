...
const STORY_SLUG = 'blog/moduluxe-group-seo-case-study'
const CANONICAL_PATH = '/blog/moduluxe-group-seo-case-study'
...
export default async function BlogmoduluxegroupseocasestudyPage({ params }: Props) {
