...
const STORY_SLUG = 'services/branding-graphic-design'
const CANONICAL_PATH = '/services/branding-graphic-design'
...
export default async function BrandingGraphicDesignPage({ params }: Props) {
