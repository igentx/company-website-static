...
const STORY_SLUG = 'services/graphic-design-uae'
const CANONICAL_PATH = '/services/graphic-design-uae'
...
export default async function GraphicDesignUaePage({ params }: Props) {
