...
const STORY_SLUG = 'services/custom-software-development'
const CANONICAL_PATH = '/services/custom-software-development'
...
export default async function CustomSoftwareDevelopmentPage({ params }: Props) {
