...
const STORY_SLUG = 'services/ecommerce-development'
const CANONICAL_PATH = '/services/ecommerce-development'
...
export default async function EcommerceDevelopmentPage({ params }: Props) {
