...
const STORY_SLUG = 'services/web-development-uae'
const CANONICAL_PATH = '/services/web-development-uae'
...
export default async function WebDevelopmentUaePage({ params }: Props) {
