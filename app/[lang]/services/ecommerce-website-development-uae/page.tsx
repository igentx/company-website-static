...
const STORY_SLUG = 'services/ecommerce-website-development-uae'
const CANONICAL_PATH = '/services/ecommerce-website-development-uae'
...
export default async function EcommerceUaePage({ params }: Props) {
