...
const STORY_SLUG = 'case-studies/web-development-startup-dr-door'
const CANONICAL_PATH = '/case-studies/dr-door'
...
export default async function DrDoorCaseStudyPage({ params }: Props) {
