...
const STORY_SLUG = 'case-studies/web-development-uae-startup-moduluxe-group'
const CANONICAL_PATH = '/case-studies/moduluxe-group'
...
export default async function ModuluxeCaseStudyPage({ params }: Props) {
