...
const STORY_SLUG = 'case-studies/bloomwave-learning-daycare'
const CANONICAL_PATH = '/case-studies/bloomwave-learning-daycare'
...
export default async function BloomwaveCaseStudyPage({ params }: Props) {
